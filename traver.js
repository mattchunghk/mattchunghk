...
for (let key in hk) {
    if (hk[key].length == 0) {
        ...
        for (let i in hk[key][0]) {
            console.log(`${key[0].toUpperCase()+ key.substring(1)}_${i}: ${hk[key][0][i]}`);
        }
        ...
        for (let i in hk[key]) {
            console.log(`${key[0].toUpperCase()+ key.substring(1)}_${i}: ${hk[key][i]}`);
        }
    } else {
...
//         for (let i in hk[key]) {
//             let x = `${key[0].toUpperCase()+ key.substring(1)}_${i}: ${hk[key][i]}`;
//             console.log(x);
//         }
//     } else if (key == "currencies") {
//         for (let i in hk[key][0]) {
//             let x = `${key[0].toUpperCase()+ key.substring(1)}_${i}: ${hk[key][0][i]}`;
//             console.log(x);
//         }
//     } else if (key == "languages") {
//         for (let i in hk[key]) {
//             for (let j in hk[key][i]) {
//                 let x = `${key[0].toUpperCase()+ key.substring(1)}_${j}: ${hk[key][i][j]}`;
//                 console.log(x);
//             }
//         }
//     } else {
